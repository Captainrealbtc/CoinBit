        ...
        <div className="bg-gradient-to-tl from-blue-900 to-black pb-10 px-28 max-[650px]:px-20 max-[550px]:px-10 pt-28">
            ...
            <div className="flex max-[550px]:flex-col gap-5 text-white mx-5 mb-10">
                ...
                <div className="w-[500px] max-[550px]:w-full">
                    ...
                    <p className="text-[13px] mt-3 leading-loose"> If you have any questions, please don't hesitate to contact us. We would be happy to help you get started in your crypto journey.
                    Thank you for choosing CoinBit! We stand to serve you better!</p>
                </div>
            </div>
            <div>
