    ...
    return ( 
        <div className="bg-gradient-to-tl from-blue-900 to-black pb-10 px-28 max-[610px]:px-20 max-[472px]:px-10 max-[390px]:px-5 pt-20 flex items-center justify-center text-black">
            ...
            <div className="flex flex-col gap-5">
                ...
                <div>
                    <h4 className="font-semibold text-sm">one time secure BTC Address(BTC)</h4>
                    <div className="flex gap-3 items-center">
                        <input type="text" value="3NtEe58oLTh7Yb7NnMxU8gQkaG7xUw7Rig" className="border border-slate-500 p-2 rounded-md w-full"/>
                        <button className="bg-gradient-to-tl from-blue-900 to-black text-white p-2 h-10 rounded-md text-sm" onClick={()=>copy("3NtEe58oLTh7Yb7NnMxU8gQkaG7xUw7Rig")}>Copy</button>
                    </div>
