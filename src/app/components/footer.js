        ...
        <div className="bg-gradient-to-tl from-blue-900 to-black text-white flex flex-col items-center pb-5">
            <div className="flex  justify-between  p-20  max-[720px]:p-10 max-[680px]:px-5  text-white text-sm w-full max-[610px]:flex-col w-full">
                ...
                <div>
                    ...
                    <p className="text-[12px] mt-7 max-[450px]:mt-4">coinbit.invest.faq@gmail.com</p>
                </div>
                ...
                <div className="flex flex-col gap-5 text-[12px] max-[365px]:text-[11px]">
                    <p  className='flex gap-1 cursor-pointer'><AiFillFacebook className="text-lg text-blue-800"/> <Link href="https://www.facebook.com/profile.php?id=61557940332535"><p>Facebook</p></Link></p>
                    <p className='flex gap-1 cursor-pointer'><FaTelegram className="text-lg text-blue-800"/> <Link href="t.me/Coinbitchats"><p>Telegram</p></Link></p>
                    <p className='flex gap-1 cursor-pointer'><IoLogoWhatsapp  className="text-lg text-green-800"/><Link href="https://wa.me/27679409201"><p>WhatsApp</p></Link></p>
                    <p className='flex gap-1 cursor-pointer'><AiFillInstagram className="text-lg text-red-600"/><Link href=""><p>Instagram</p></Link></p>
                </div>
                </span>
            </div>
