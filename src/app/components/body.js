    ...
    return ( 
        <div className="bg-white text-black mt-24 max-[875px]:mt-10 max-[720px]:mt-5  flex flex-col items-center justify-center px-28 max-[875px]:px-10  gap-5 pt-20">
            ...
            <p className="text-center text-sm leading-loose text-slate-500" data-aos="fade-zoom-in">
                CoinBit is a team of wholesale investors, analysts and programmers. We have been working on cryptocurrency platforms (and not only) for more than 10 years and have a competitive portfolio. All meetings, communications and agreements with our partners (clients) are held in a transparent manner.
            </p>
